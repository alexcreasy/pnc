...
(function () {
  ...
  module.config(['$stateProvider', function ($stateProvider) {
    ...
    $stateProvider.state('report.product-shipped', {
      url: '/product-shipped',
	  templateUrl: 'pnc/report/views/product.shipped.artifacts.html',
	  data: {
    ...
    $stateProvider.state('report.products-for-artifact', {
      ...
      templateUrl: 'pnc/report/views/products.for.artifact.html',
      data: {
    ...
    $stateProvider.state('report.blacklisted-artifacts-in-project', {
      ...
      templateUrl: 'pnc/report/views/blacklisted.artifacts.in.project.html',
      data: {
    ...
    $stateProvider.state('report.different-artifacts-in-products', {
        ...
        templateUrl: 'pnc/report/views/different.artifacts.in.products.html',
        data: {
    ...
    $stateProvider.state('report.built-artifacts-in-project', {
      ...
      templateUrl: 'pnc/report/views/built.artifacts.in.project.html',
      data: {
    ...
    $stateProvider.state('report.project-product-diff', {
      url: '/project-product-diff',
    	templateUrl: 'pnc/report/views/project.product.diff.html',
    	data: {
