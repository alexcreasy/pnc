  ...
  module.config([
    ...
    function ($stateProvider, $urlRouterProvider) {
      ...
      $stateProvider.state('build-groups.list', {
        url: '',
        templateUrl: 'pnc/build-groups/views/build-groups.list.html',
        data: {
      ...
      $stateProvider.state('build-groups.detail', {
        ...
        templateUrl: 'pnc/build-groups/views/build-groups.detail.html',
        data: {
      ...
      $stateProvider.state('build-groups.create', {
        ...
        templateUrl: 'pnc/build-groups/views/build-groups.create.html',
        data: {
      ...
      $stateProvider.state('build-groups.add-configuration', {
        ...
        templateUrl: 'pnc/build-groups/views/build-groups.add.configuration.html',
        data: {
