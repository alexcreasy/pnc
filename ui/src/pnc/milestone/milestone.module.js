  ...
  module.config(['$stateProvider', function ($stateProvider) {
    ...
    $stateProvider
      .state('product.detail.version.milestoneDetail', {
        ...
        views: {
          'content@': {
            templateUrl: 'pnc/milestone/views/milestone.detail.html',
      ...
      .state('product.detail.version.milestoneDetail.log', {
        ...
        views: {
          'content@': {
             templateUrl: 'pnc/milestone/views/milestone.detail.log.html',
      ...
      .state('product.detail.version.milestoneCreate', {
        ...
        views: {
          'content@': {
            templateUrl: 'pnc/milestone/views/milestone.create-update.html',
      ...
      .state('product.detail.version.milestoneClose', {
        ...
        views: {
          'content@': {
            templateUrl: 'pnc/milestone/views/milestone.close.html',
