  ...
  module.config([
    ...
    function ($stateProvider, $urlRouterProvider) {
      ...
      $stateProvider.state('build-records', {
        ...
        views: {
          'content@': {
            templateUrl: 'pnc/common/templates/single-col.tmpl.html'
          }
        },
        data: {
      ...
      //   templateUrl: 'pnc/build-records/views/build-records.detail.result.html',
      //   data: {
      //     displayName: 'Log'
      //   },
      //   resolve: {
      ...
      //   templateUrl: 'pnc/build-records/views/build-records.detail.artifacts.html',
      //   data: {
      ...
      $stateProvider.state('build-records.list', {
        url: '',
        templateUrl: 'pnc/build-records/views/build-records.list.html',
        data: {
          displayName: 'Builds'
        },
      ...
      $stateProvider.state('projects.detail.build-configs.detail.build-records.detail', {
        abstract: true,
        url: '/{recordId:int}',
        templateUrl: 'pnc/build-records/views/build-records.detail.html',
        data: {
      ...
      $stateProvider.state('projects.detail.build-configs.detail.build-records.detail.default', {
        url: '',
        templateUrl: 'pnc/build-records/views/build-records.detail.default.html',
        data: {
      ...
      $stateProvider.state('projects.detail.build-configs.detail.build-records.detail.repour-result', {
        ...
        templateUrl: 'pnc/build-records/views/build-records.detail.repour-result.html',
        data: {
