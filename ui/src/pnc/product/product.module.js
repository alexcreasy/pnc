...
(function () {
  ...
  module.config(['$stateProvider', function($stateProvider) {
    ...
    $stateProvider.state('product.list', {
      url: '/',
      templateUrl: 'pnc/product/views/product.list.html',
      data: {
    ...
    $stateProvider.state('product.detail', {
      url: '/{productId:int}',
      templateUrl: 'pnc/product/views/product.detail.html',
      data: {
    ...
    $stateProvider.state('product.detail.version', {
      ...
      views: {
        'content@': {
          templateUrl: 'pnc/product/views/product.version.html',
    ...
    $stateProvider.state('product.create', {
      url: '/create',
      templateUrl: 'pnc/product/views/product.create.html',
      data: {
    ...
    $stateProvider.state('product.detail.createVersion', {
      ...
      views: {
        'content@': {
          templateUrl: 'pnc/product/views/product.version.create.html',
