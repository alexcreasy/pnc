  ...
  module.config([
    ...
    function ($stateProvider, $urlRouterProvider) {
      ...
      $stateProvider.state('configuration-set-record.list', {
        url: '',
        templateUrl: 'pnc/configuration-set-record/views/record.list.html',
        data: {
      ...
      $stateProvider.state('configuration-set-record.detail', {
        url: '/{recordId:int}',
        templateUrl: 'pnc/configuration-set-record/views/record.detail.html',
        data: {
      ...
      $stateProvider.state('configuration-set-record.detail.info', {
        url: '/info',
        templateUrl: 'pnc/configuration-set-record/views/record.detail.info.html',
        data: {
