  ...
  module.config([
    ...
    function($stateProvider, $urlRouterProvider) {
      ...
      $stateProvider.state('projects.list', {
        url: '',
        templateUrl: 'pnc/projects/views/projects.list.html',
        data: {
      ...
      $stateProvider.state('projects.detail', {
        url: '/{projectId:int}',
        templateUrl: 'pnc/projects/views/projects.detail.html',
        data: {
      ...
      $stateProvider.state('projects.detail.create-bc', {
        url: '/create-bc',
        templateUrl: 'pnc/projects/views/projects.detail.create-bc.html',
        data: {
      ...
      $stateProvider.state('projects.create', {
        url: '/create',
        templateUrl: 'pnc/projects/views/projects.create.html',
        data: {
