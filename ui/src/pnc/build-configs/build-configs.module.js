  ...
  module.config([
    ...
    function($stateProvider, $urlRouterProvider) {
      ...
      $stateProvider.state('projects.detail.build-configs', {
        ...
        views: {
          'content@': {
            templateUrl: 'pnc/common/templates/two-col-right-sidebar.tmpl.html'
          }
        },
        data: {
      ...
      $stateProvider.state('projects.detail.build-configs.detail', {
        ...
        views: {
          '': {
            templateUrl: 'pnc/build-configs/views/build-configs.detail-main.html',
            controller: 'ConfigurationDetailController',
            controllerAs: 'detailCtrl'
          },
          'sidebar': {
            templateUrl: 'pnc/build-configs/views/build-configs.detail-sidebar.html',
      ...
      $stateProvider.state('build-configs.list', {
        url: '',
        templateUrl: 'pnc/build-configs/views/build-configs.list.html',
        data: {
      ...
      $stateProvider.state('build-configs.create', {
        url: '/create',
        templateUrl: 'pnc/build-configs/views/build-configs.create.html',
        data: {
